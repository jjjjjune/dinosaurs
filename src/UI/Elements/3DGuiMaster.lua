...
function _Gui3D.buildFrame(paramModel)
	...
	local function setModel(paramModel)
		...
		local modelCentre, modelSize, modelOffset = model.PREVIEW.Position, model.PREVIEW.Size, model.PREVIEW.Position-model.PrimaryPart.Position
...
function _Gui3D:Update()
	...
	-- Set parent.
	if frame == nil then self:Destroy() return end
