...
function RespawnManager:start()
    ...
    Messages:hook("CharacterAdded", function(player, character)
        ...
        Messages:send("CreateItem", "Thornberry", (altar.PrimaryPart.CFrame * CFrame.new(20,20,0)).p)
        Messages:send("CreateItem", "Log", (altar.PrimaryPart.CFrame * CFrame.new(20,30,0)).p)
        Messages:send("CreateItem", "Clay Brick", (altar.PrimaryPart.CFrame * CFrame.new(20,25,0)).p)
        Messages:send("CreateItem", "Bucket", (altar.PrimaryPart.CFrame * CFrame.new(20,40,0)).p)
    end)
